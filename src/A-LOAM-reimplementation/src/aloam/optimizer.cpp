...
#include "aloam_velodyne/aloam/lidar_factor.hpp"
...
/**
  ...
  * @return void
  */
bool Optimizer::AddPlaneNormFactor(
    const Eigen::Vector3d &source,
...
/**
  ...
  */
bool Optimizer::GetOptimizedRelativePose(Eigen::Quaterniond &dq, Eigen::Vector3d &dt) {
    dq.x() = param_.q[0];
    dq.y() = param_.q[1];
    dq.z() = param_.q[2];
    dq.w() = param_.q[3];
